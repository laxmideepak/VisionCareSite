        ...
        <div className="lg:hidden">
          ...
          <div className="text-center py-6 sm:py-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6 text-center px-2">
              <span className="text-orange-400">{t('eyeExam')}</span><br />
              <span className="text-xl sm:text-2xl md:text-3xl lg:text-4xl">{t('nearYou')}</span><br />
              <span className="text-orange-400 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold">{t('discount')}</span><br />
              <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl">{t('ifCallOrBook')}</span><br />
              <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl">{t('online')}</span>
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-3xl lg:text-5xl font-bold leading-tight mb-6 text-center lg:text-left">
                <span className="text-orange-400">{t('eyeExam')}</span><br />
                <span className="text-2xl lg:text-4xl">{t('nearYou')}</span><br />
                <span className="text-orange-400 text-4xl lg:text-6xl font-bold">{t('discount')}</span><br />
                <span className="text-xl lg:text-3xl">{t('ifCallOrBook')}</span><br />
                <span className="text-xl lg:text-3xl">{t('online')}</span>
              </h1>
              <p className="text-sm mb-8 text-blue-100">{t('disclaimer')}</p>
