        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mt-6 sm:mt-8 px-4">
            <a 
              ...
              className="bg-primary-600 text-white px-6 py-4 rounded-lg font-semibold hover:bg-primary-700 active:bg-primary-800 transition-colors duration-200 touch-manipulation"
            >
              <Phone className="w-4 h-4 mr-2 inline" />Call Us
            </a>
            <a 
              href="https://scheduleyourexam.com/v3/index.php/9227/" 
              className="bg-orange-500 text-white px-6 py-4 rounded-lg font-semibold hover:bg-orange-600 active:bg-orange-700 transition-colors duration-200 touch-manipulation"
            >
              Book Online
            </a>
          </div>
