  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile: Call and WhatsApp buttons below logo */}
        <div className="md:hidden pb-3">
          <div className="flex space-x-2">
            ...
            <a 
              ...
              className="flex-1 bg-green-500 hover:bg-green-600 active:bg-green-700 text-white px-3 py-3 rounded-lg font-semibold text-center transition-colors duration-200 flex items-center justify-center text-sm touch-manipulation"
            >
