      ...
      <section className="bg-blue-600 text-white py-12 sm:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 px-2">
            ...
            <span className="text-orange-400">{t('offIfCallOrBook')}</span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">{t('bookYourExamAppointment')}</h2>
              <p className="text-base sm:text-lg text-gray-700 mb-6 sm:mb-8 leading-relaxed">
                {t('locationDescription')} <a 
                ...
                >4396 Dallas Fort Worth Turnpike Ste 107, Dallas, TX 75211</a>, {t('whichMeans')}
              </p>
              <a 
                href="https://scheduleyourexam.com/v3/index.php/9227/" 
              ...
              <div className="mb-6 sm:mb-8">
                <p className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">{t('weAcceptNow')}</p>
                <img 
